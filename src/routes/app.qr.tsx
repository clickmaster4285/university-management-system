...
export const Route = createFileRoute("/app/qr")({
  head: () => ({
    meta: [
      { title: "Smart QR — ScholarOS" },
      { name: "description", content: "Every student carries a QR code that opens attendance, fees, library, hostel, and transport records." },
      { property: "og:title", content: "Smart QR — ScholarOS" },
      { property: "og:description", content: "One QR, entire university." },
    ],
  }),
  component: QrPage,
});
