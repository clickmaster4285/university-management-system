...
export const Route = createFileRoute("/app/semesters")({
  head: () => ({
    meta: [
      { title: "Semesters — ScholarOS" },
      { name: "description", content: "Manage semesters, add semesters to academic sessions, and track academic periods." },
    ],
  }),
