...
function AssignmentsPage() {
  ...
  const handleCourseSelect = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedCourse) {
      ...
      if (selectedCourse.semester === 'Fall') semesterNumber = 1;
      else if (selectedCourse.semester === 'Spring') semesterNumber = 2;
      else if (selectedCourse.semester === 'Summer') semesterNumber = 3;
