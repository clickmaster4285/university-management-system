...
export const Route = createFileRoute("/app/ai")({
  head: () => ({
    meta: [
      { title: "AI Assistant — ScholarOS" },
      { name: "description", content: "Ask anything about your university — attendance, admissions, fees, performance." },
      { property: "og:title", content: "AI Assistant — ScholarOS" },
      { property: "og:description", content: "Conversational AI for university operations." },
    ],
  }),
  component: AIPage,
});
