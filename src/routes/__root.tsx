...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "ScholarOS — The University Operating System" },
      { name: "twitter:description", content: "One platform for admissions, academics, attendance, fees, hostel, transport, and AI-driven insights across every campus." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d9755c2e-508b-4487-8681-9d4f65a45a5c/id-preview-0b74f348--420f131a-8a85-4595-942d-73028f017f5a.lovable.app-1784788079999.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d9755c2e-508b-4487-8681-9d4f65a45a5c/id-preview-0b74f348--420f131a-8a85-4595-942d-73028f017f5a.lovable.app-1784788079999.png" },
    ],
    links: [
