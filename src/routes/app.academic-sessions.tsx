...
export const Route = createFileRoute("/app/academic-sessions")({
  head: () => ({
    meta: [
      { title: "Academic Sessions — ScholarOS" },
      { name: "description", content: "Manage academic sessions, set current session, and track academic years." },
    ],
  }),
